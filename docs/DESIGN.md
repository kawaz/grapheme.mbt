...
src/
  ...
  uax29_test.mbt       # ブラックボックステスト: 公式テストデータ全1,568件
tools/
...
**出力:** `src/uax29_test.mbt` — 1,568件のテスト関数
...
`tools/gen_uax29_tests.py` が `GraphemeBreakTest.txt` の全1,568ケースを
