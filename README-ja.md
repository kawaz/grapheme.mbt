...
- 対応バックエンド: wasm-gc, js, native
- バンドルサイズ: wasm-gc ~25 KB / js ~59 KB / native ~56 KB
...
<details>
<summary>JSON 形式（moon.pkg.json）の場合</summary>
...
- 遅延評価イテレータ `grapheme_iter()` — early-break 時に最大 64x 高速
